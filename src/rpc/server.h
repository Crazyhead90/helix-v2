...
extern double GetDifficulty(const CBlockIndex* blockindex = NULL, int algo = -1, bool weighted = true, bool next = true);
extern double GetPeakHashrate(const CBlockIndex* blockindex = NULL, int algo = 0, bool giga = true);
extern double GetCurrentHashrate(const CBlockIndex* blockindex = NULL, int algo = 0, bool giga = true);
extern double GetMoneySupply(const CBlockIndex* blockindex = NULL, int algo = -1);
extern double GetBlockReward(CBlockIndex* blockindex = NULL, int algo = 0, bool noScale = false);
extern int GetNBlocksUpdateSSF(const CBlockIndex* blockindex = NULL, int algo = 0);
extern double GetAverageBlockSpacing(const CBlockIndex * blockindex = NULL, int algo = -1, int averagingInterval = 25);
...
extern UniValue setzhlixseed(const UniValue& params, bool fHelp);
extern UniValue getzhlixseed(const UniValue& params, bool fHelp);
...
extern UniValue chaindynamics(const UniValue& params, bool fHelp);
extern UniValue getblockspacing(const UniValue& params, bool fHelp);
...
extern UniValue setminingalgo(const UniValue& params, bool fHelp);
extern UniValue getminingalgo(const UniValue& params, bool fHelp);

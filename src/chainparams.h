 ...
 * Helix system. There are three: the main network on which people trade goods
...
public:
  ...
  int COINBASE_MATURITY() const { if (NetworkID() == CBaseChainParams::TESTNET) return nMaturity/5; return nMaturity; }
    ...
    int MultiPow_StartHeight() const { return nMultiPowStartHeight; }
  int CEM_StartHeight() const { return nCEMStartHeight; }
